...
| Success message not showing when an item was added to the wishlist                                           | Corrected the template by changing the previously disabled button into a "Remove from Wishlist" URL.                                                                                                                       |
